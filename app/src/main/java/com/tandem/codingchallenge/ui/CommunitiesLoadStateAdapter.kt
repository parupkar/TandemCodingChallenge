...
import com.tandem.codingchallenge.databinding.ItemLoadingStateBinding

class CommunitiesLoadStateAdapter(
    private val retry: () -> Unit
) : LoadStateAdapter<CommunitiesLoadStateAdapter.PassengerLoadStateViewHolder>() {
